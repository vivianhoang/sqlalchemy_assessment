...
class Brand(db.Model):
    ...
    id = db.Column(db.Integer, autoincrement=True, primary_key=True)
    name = db.Column(db.String(50), db.ForeignKey('models.id'))
    ...
    def __repr__(self):
        ...
        return "<Brand name=%s founded=%s headquarters=%s discontinued=%s>" % (self.name, self.founded, self.headquarters, self.discontinued)
